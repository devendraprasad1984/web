var demoPanel = (function ($) {
    "use strict";
    var demoPanel = $("#lm_demo_panel"), demoPanelSwitcher = $("#lm_demo_panel_switcher");
    ...
    $('#main_color').on("click", "a", function () {
        var head = $('head'), selector = $(this).data("id");
        ...
        var color=$(".current-main-color").css("background-color")
        $(".btn, .badge").css({"background-color":color,"color":"white"})
    });
})(jQuery);